...
// Light Theme Colors
val PrimaryLight = Color(0xFF4A3B89)
val OnPrimaryLight = Color(0xFFFFFFFF)
val PrimaryContainerLight = Color(0xFFE7DFF8)
val OnPrimaryContainerLight = Color(0xFF1A1632)
...
val OnPrimaryDark = Color(0xFF2F2A48)
val PrimaryContainerDark = Color(0xFF453B6F)
